                ...
                <div className="mb-3">
                    <div>
                        ...
                        >
                            ...
                            <button type="button" onClick={() => captureImage(3)} className="pulse" id='pulse'>Tomar Foto Lateral Izq</button>
                        </Modal>
                ...
                <div className="mb-3">
                    <div>
                        ...
                        >
                            ...
                            <button type="button" onClick={() => captureImage(4)} className="pulse" id='pulse'>Tomar Foto Lateral Der</button>
                        </Modal>
                        {capturedImages[4] && <img src={capturedImages[4]} alt="Captured" width='200px' height='170px'/>}
                    </div>
                </div>
